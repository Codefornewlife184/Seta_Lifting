...
var Swiper = (function () {
  ...
  const ce = [
    ...
    function (e) {
      ...
      // Başlangıçta autoplay ayarları
      (i.autoplay = { running: !1, paused: !1, timeLeft: 0 }),
      r({
        autoplay: {
          enabled: !0, // Autoplay'i etkinleştir
          delay: 3000, // Gecikme süresi
          waitForTransition: !0,
          disableOnInteraction: !0,
          stopOnLastSlide: !1,
          reverseDirection: !1,
          pauseOnMouseEnter: !0, // Fare imleci üzerine gelince durdur
        },
      });
      ...
      // Fare ile üzerlerine gelindiğinde durdurma
      i.on('mouseenter', () => {
        i.autoplay.pause(); // Otomatik kaydırmayı durdur
      });
    
      // Fare çıktığında başlatma
      i.on('mouseleave', () => {
        i.autoplay.start(); // Otomatik kaydırmayı başlat
      });
      function b(e) {
        i &&
          !i.destroyed &&
